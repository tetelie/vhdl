...
REM
REM Generated by Vivado on Fri Jan 24 09:35:43 +0100 2025
...
call xsim  test_pulse_gen_behav -key {Behavioral:sim_1:Functional:test_pulse_gen} -tclbatch test_pulse_gen.tcl -log simulate.log
